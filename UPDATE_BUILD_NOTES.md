...
- Négyzetméterarányos közösköltség update build: `0.1.5`
...
- Használandó fájl: `hazpenztar_0.1.5_x64_en-US.msi`
...
- A lakások közös költsége a 2026-03-22-es mentésből visszaállított négyzetméterarányos díjtáblát használja.

## Ellenőrzés telepítés előtt

1. Készíts JSON exportot az éles programból.
2. Futtasd az új `hazpenztar_0.1.5_x64_en-US.msi` telepítőt.
